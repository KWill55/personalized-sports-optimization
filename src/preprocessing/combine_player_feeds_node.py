...
# Support direct execution: python3 src/preprocessing/combine_player_feeds_node.py
SRC_ROOT = Path(__file__).resolve().parents[1]
if str(SRC_ROOT) not in sys.path:
    sys.path.append(str(SRC_ROOT))

from preprocessing.combine_player_feeds_lib import run_combine_player_feeds_pipeline
